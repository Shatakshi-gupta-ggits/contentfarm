            ...
            <div className="grid lg:grid-cols-2 gap-8 relative">
              ...
              <div className="hidden lg:flex absolute -top-12 left-1/2 -translate-x-1/2 gap-32 z-10">
                ...
                ease: "easeInOut"
                  ...
                  <ArrowDownLeft className="w-12 h-12 text-primary" strokeWidth={2} style={{
                ...
                ease: "easeInOut"
                  ...
                  <ArrowDownRight className="w-12 h-12 text-primary" strokeWidth={2} style={{
                  filter: "drop-shadow(0 0 8px hsl(var(--primary) / 0.6))"
                }} />
                </motion.div>
              </div>
              ...
              <Card className="p-8 border-2 border-primary">
                <div className="mb-6">
                  <h3 className="text-2xl font-bold mb-2">Path 1: The Viral UGC System</h3>
                  <p className="text-lg font-semibold text-primary">We Generate $15,000+ in New MRR From Viral Videos in 90 Days Or You Don't Pay</p>
                ...
                <div className="space-y-6 mb-8">
                  ...
                  <div>
                    <h4 className="font-bold text-lg mb-2">The Solution: Our Video Content Creator System</h4>
                    <p className="text-muted-foreground">We build and manage a performance-based video creator team for you in 30 days. 50+ creators will generate hundreds of authentic videos about your product, creating a wave of social proof that drives qualified traffic and sign-ups. You only pay for results, and you keep 100% of the new revenue.</p>
                  </div>
                </div>
                ...
                <Button size="lg" className="w-full" onClick={() => window.location.href = 'https://contentfarm.club/creator-led'}>
              ...
              <Card className="p-8 border-2 border-primary">
                ...
                <Button size="lg" className="w-full" onClick={() => window.location.href = 'https://contentfarm.club/#services'}>
                  Check More →
                </Button>
              </Card>
            </div>
