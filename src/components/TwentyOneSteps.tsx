...
const TwentyOneSteps = () => {
  ...
  return <section className="pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          once: true
            ...
            <h2 className="text-4xl sm:text-5xl font-bold mb-6 gradient-text">
              The 27-step Video Content Creator System
            </h2>
        ...
        <div className="space-y-6">
          {phases.map((phase, phaseIndex) => <motion.div key={phase.num} initial={{
          opacity: 0,
          y: 20
        }} whileInView={{
          opacity: 1,
          ...
          once: true
              ...
              {/* Phase Header */}
              <button onClick={() => setExpandedPhase(expandedPhase === phaseIndex ? null : phaseIndex)} className={`w-full p-6 sm:p-8 flex items-center justify-between bg-gradient-to-r ${phase.color} border-l-4 ${phase.borderColor} hover:opacity-80 transition-all duration-300`}>
                ...
                <motion.div animate={{
              rotate: expandedPhase === phaseIndex ? 180 : 0
            }} transition={{
              duration: 0.3
              ...
              {/* Phase Steps */}
              <AnimatePresence>
                {expandedPhase === phaseIndex && <motion.div initial={{
              height: 0,
              opacity: 0
            }} animate={{
              height: "auto",
              ...
              duration: 0.3
                    ...
                    <div className="p-6 sm:p-8 space-y-4 bg-accent/5">
                      {phase.steps.map((step, stepIndex) => <motion.div key={step.num} initial={{
                  opacity: 0,
                  x: -20
                }} animate={{
                  opacity: 1,
        ...
        <div className="text-center mt-12">
          <a href="/schedule">
            <button className="bg-primary text-primary-foreground px-12 py-6 rounded-lg text-xl font-bold hover:opacity-90 transition-all duration-300">
              Schedule A Call
            </button>
          </a>
        </div>
